...
struct hash_data_node_s {
    char *name;
    void *data;
    struct hlist_node ptr;
};
typedef struct hash_data_node_s hasht_node;

struct hash_data_table_s {
    uint num;
    uint mask;
    struct hlist_head *head;
};
typedef struct hash_data_table_s hasht_table;
 ...
 */
static inline void linux_list_add(struct list_head *new, struct list_head *head)
{
 ...
 */
static inline void linux_list_add_tail(struct list_head *new, struct list_head *head)
{
