...
**/
	json_t *json_new_value (ngx_pool_t *, const enum json_value_type type);
...
**/
	json_t *json_new_string (ngx_pool_t *, const char *text);
...
@return a pointer to the newly created JSON string value
**/
	json_t *json_new_number (ngx_pool_t *, const char *text);
...
**/
	json_t *json_new_object (ngx_pool_t *);
...
**/
	json_t *json_new_array (ngx_pool_t *);
...
**/
	json_t *json_new_null (ngx_pool_t *);
...
**/
	json_t *json_new_true (ngx_pool_t *);
...
**/
	json_t *json_new_false (ngx_pool_t *);
...
@return the error code corresponding to the operation result
**/
	enum json_error json_insert_pair_into_object (ngx_pool_t *, json_t * parent, const char *text_label, json_t * value);
...
**/
	enum json_error json_tree_to_string (ngx_pool_t *, json_t * root, char **text);
...
**/
	char *json_format_string (ngx_pool_t *, char *text);
...
**/
	char *json_escape (ngx_pool_t *, char * text);
...
**/
	enum json_error json_parse_fragment (ngx_pool_t *, struct json_parsing_info *info, char *buffer);
...
**/
	enum json_error json_parse_document (ngx_pool_t *, json_t **root, char *text);
...
**/
	enum json_error json_saxy_parse (ngx_pool_t *, struct json_saxy_parser_status *jsps, struct json_saxy_functions *jsf, char c);
...
#define ngx_json_new_array 	json_new_array
#define ngx_json_new_object json_new_object
#define ngx_json_new_string json_new_string
#define ngx_json_insert_child json_insert_child
#define ngx_json_tree_to_string json_tree_to_string
#define ngx_json_free_value	json_free_value
